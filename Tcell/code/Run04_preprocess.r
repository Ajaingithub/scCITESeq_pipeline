...
savedir = "/mnt/data/projects/.immune/Mayo/Ines/Fibro_Tcells/analysis/downstream/seurat_R/Run04/"

#### Generating the singlet file for each run #####
## In directory Run02 by mistake I wrote Run07 so ignore it
dir_run01 = "/mnt/data/projects/.immune/Mayo/Ines/Fibro_Tcells/analysis/preprocessing/Run04_CR9/outs/per_sample_outs/"
